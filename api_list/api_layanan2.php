 ...
 */
$aColumns=array('Aset_ID', 'kodeKelompok', 'kodeSatker',  'noRegister', 'noKontrak', 'TglPerolehan', 'TglPembukuan', 'NilaiPerolehan', 'Info','TipeAset','Tahun');
...
while ($aRow = mysql_fetch_array($rResult)) {
    ...
    //echo "tes";
     ...
     $row[] = "<center>".$TglPerolehan."/"."<br/>".$TglPembukuan."</center>";
     $row[] = "$NilaiPerolehan";
     $row[] = "$info";
